/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 753f64cd5b16612084ca58f86db9c08a)
// Runtime types generated with workerd@1.20260305.0 2026-02-24 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		AI: Ai;
		ASSETS: Fetcher;
		AI_SEARCH_ID: "era-ai-search";
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_API_TOKEN: string;
		DB: Fetcher /* chatroom-do */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_SEARCH_ID" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN">> {}
}
